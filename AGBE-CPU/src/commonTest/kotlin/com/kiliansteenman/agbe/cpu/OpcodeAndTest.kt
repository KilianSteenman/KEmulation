...
class OpcodeAndTest : OpcodeBaseTest() {
    ...
    private val values = arrayOf(
        AndOpcode(0xA7.toByte(), 'A', 'A', 0b11110000, 0b11110000, 0b11110000),
        AndOpcode(0xA0.toByte(), 'A', 'B', 0b11110010, 0b11110001, 0b11110000),
        AndOpcode(0xA1.toByte(), 'A', 'C', 0b11110010, 0b11110001, 0b11110000),
        AndOpcode(0xA2.toByte(), 'A', 'D', 0b11110010, 0b11110001, 0b11110000),
        AndOpcode(0xA3.toByte(), 'A', 'E', 0b11110010, 0b11110001, 0b11110000),
        AndOpcode(0xA4.toByte(), 'A', 'H', 0b11110010, 0b11110001, 0b11110000),
        AndOpcode(0xA5.toByte(), 'A', 'L', 0b11110010, 0b11110001, 0b11110000),
    )
